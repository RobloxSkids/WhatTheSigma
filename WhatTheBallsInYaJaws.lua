...
local themes = {
    Dark = {
        ...
        MainFrame = Color3.fromRGB(255, 130, 9),
    ...
    function windowTypes:Tab(name)
        ...
        function tabTypes:Section(opts)
            ...
            function sectionTypes:ToggleColorPicker(opts)
                ...
                inputService.InputChanged:Connect(function(input)
                    if inputinput.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                        if slidingHue then
                            updateHue(input)
                        end
                    end
